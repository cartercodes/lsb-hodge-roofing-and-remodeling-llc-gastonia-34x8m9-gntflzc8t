...
const services = [
  { title: 'Roof Replacement', desc: 'When Gastonia\'s summer storms and Carolina humidity take their toll, Hodge Roofing delivers full roof replacements built to last decades. We handle everything from tear-off to final inspection so you never have to worry.', icon: serviceIcons[0] },
  { title: 'Storm Damage Repair', desc: 'Hail, high winds, and heavy rain hit Gaston County hard. Our crew responds fast to assess damage, work directly with your insurance, and restore your roof before the next storm rolls in.', icon: serviceIcons[1] },
  { title: 'Roof Inspections', desc: 'Protect your investment with a thorough roof inspection from Hodge Roofing. We catch small problems early so Gastonia homeowners avoid costly surprises down the road.', icon: serviceIcons[2] },
  { title: 'Gutter Installation', desc: 'Properly installed gutters protect your foundation and landscaping from North Carolina\'s heavy rainfall. We custom-fit seamless gutters that handle whatever the sky throws at your home.', icon: serviceIcons[3] },
  { title: 'Siding and Exterior Remodeling', desc: 'From vinyl siding to complete exterior makeovers, we help Gastonia homeowners boost curb appeal and property value with craftsmanship that stands up to Carolina weather.', icon: serviceIcons[4] },
  { title: 'Interior Remodeling', desc: 'Hodge Roofing and Remodeling does more than roofs. We bring the same attention to detail inside your home with kitchen, bathroom, and whole-room renovations Gastonia families love.', icon: serviceIcons[5] },
];

const trustItems = [
  'Serving Gastonia and Gaston County for Over a Decade',
  'Licensed, Insured, and NC Building Code Certified',
  'Hundreds of Five-Star Reviews from Local Homeowners',
  'Free Estimates with Honest, No-Pressure Pricing',
];
        ...
        <div className="about-inner">
          ...
          <div className="about-content">
            ...
            <p className="about-text" data-animate data-delay="2">
              {'Hodge Roofing and Remodeling LLC was built on a simple promise: treat every Gastonia home like it is our own. From rooftop to living room, our local crew brings reliable craftsmanship and straight talk to every project across Gaston County. We are proud to be the name Gastonia homeowners call first and recommend to their neighbors.'}
            </p>
