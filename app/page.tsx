...
const services = [
  { title: 'Roof Replacement', desc: 'When Gastonia\'s summer storms take their toll, Hodge Roofing delivers full roof replacements built to last decades. We handle everything from tear-off to final inspection so you never have to chase down another contractor.', icon: serviceIcons[0] },
  { title: 'Storm Damage Repair', desc: 'Hail, wind, and heavy rain hit Gaston County hard. We respond fast with thorough damage assessments and work directly with your insurance to get your roof restored right.', icon: serviceIcons[1] },
  { title: 'Roof Inspections', desc: 'Buying a home in Gastonia or just want peace of mind? Our detailed roof inspections catch hidden damage before it becomes a costly problem.', icon: serviceIcons[2] },
  { title: 'Gutter Installation', desc: 'Protect your foundation and landscaping with professionally installed gutters designed for North Carolina\'s heavy rainfall. Seamless options available for a clean, lasting finish.', icon: serviceIcons[3] },
  { title: 'Home Remodeling', desc: 'From kitchen renovations to bathroom upgrades, our remodeling crew brings the same craftsmanship we\'re known for on rooftops right into your Gastonia home.', icon: serviceIcons[4] },
  { title: 'Siding & Exterior Work', desc: 'Complete your home\'s curb appeal with durable siding that stands up to Carolina weather. We match materials and colors to give your property a cohesive, polished look.', icon: serviceIcons[5] },
];

const trustItems = [
  'Serving Gastonia & Gaston County Homeowners for Over a Decade',
  'Licensed, Insured & NC Building Code Certified',
  'Hundreds of Roofs Replaced Across the Greater Charlotte Region',
  '5-Star Rated With Transparent Pricing — No Surprise Costs',
];
    ...
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-inner">
          <span className="nav-logo">{'Hodge Roofing and Remodeling LLC'}</span>
          <a
            href="tel:19842664243"
            className="nav-phone-btn"
            aria-label="Call Hodge Roofing and Remodeling LLC at +1 984-266-4243"
          >
            <span
            ...
            />
            <span className="nav-phone-text">{'+1 984-266-4243'}</span>
          </a>
        </div>
      </nav>
        ...
        <div className="hero-content">
          <div className="hero-glass-card">
            ...
            <h1 className="hero-title">
              Expert Roofing Contractor in {'Gastonia'}, {'NC'}
            </h1>
            <p className="hero-subtitle">
              From storm damage repairs to complete roof replacements,{' '}
              {'Hodge Roofing and Remodeling LLC'} delivers durable, code-compliant roofing
              solutions that protect your home and family across {'Gastonia'}.
            </p>
            <a
              href="tel:19842664243"
              className="hero-cta"
              aria-label="Call now at +1 984-266-4243"
            >
              <span
        ...
        <div className="about-inner">
          ...
          <div className="about-content">
            ...
            <h2 className="about-title" data-animate data-delay="1">
              Why {'Gastonia'} Trusts {'Hodge Roofing and Remodeling LLC'}
            </h2>
            <p className="about-text" data-animate data-delay="2">
              {'Hodge Roofing and Remodeling LLC was built on a simple promise: treat every Gastonia home like it\'s our own. From storm-damaged shingles on Franklin Boulevard to full remodels in the Crowders Mountain neighborhoods, we bring honest pricing, skilled hands, and the kind of follow-through that keeps our neighbors coming back. When your home needs work, you deserve a local team that actually picks up the phone.'}
            </p>
        ...
        <div className="cta-section-inner" data-animate>
          <div className="cta-glass-card">
            <h2 className="cta-section-title">
              Contact {'Hodge Roofing and Remodeling LLC'}
            </h2>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-inner">
          <span className="footer-brand">{'Hodge Roofing and Remodeling LLC'}</span>
          <div className="footer-info">
            <div className="footer-info-item">
              ...
              />
              <span>
                {'1020 S Marietta St, Gastonia, NC 28054, USA'}, {'Gastonia'}, {'NC'}
              </span>
            </div>
            <div className="footer-info-item">
              <span
          ...
          <div className="footer-copyright">
            &copy; {new Date().getFullYear()} {'Hodge Roofing and Remodeling LLC'}. All rights
